...
<b>not-defined</b !imortant> - Jis cheez ka existance hi nahi hai, wo not-defined hota hai.<br><br>
...
Means let and const varibable shirf curly braces ke andar hi use kiye ja sakte hai uske bahar nahi.<br><br>
Example:<br><br>
`,
      codee2: `
function abcd(){
...
<br><br>
var keyword ke saath declare ki gayi variables adds itself to the window object that is bad thing because it exposes variable data and that's why let aur const keywords ka istemal prefer kiya jaata hai.<br><br>
...
<h3> We don't use js features always. </h3 !important>
...
Ise object-oriented programming (OOP) ka ek part bhi kaha ja sakta hai, jahan hum data aur functions ko encapsulate karke ek single unit me rakhte hain.
    ...
    `,
      ...
      contentt20: `
      - Constructor Function: Template for creating objects.<br>
      - Prototype: An object from which other objects inherit properties and methods.<br>
      - Prototypal Inheritance: Allows objects to share properties and methods.<br>
      - Example: Creating objects using constructor function and accessing prototype properties and methods.<br>
<br><br>
...
Coercion or Implicit Typecasting wo process hai jismein JavaScript automatically (implicitly) data type ko convert kar deta hai jab zaroorat hoti hai. JavaScript apne aap hi kuch operations ke dauran types ko badal deta hai.<br><br>
...
`,
      content9: `
      Is example me, IIFE function ek object return kar raha hai jiske andar do methods hai getter() and setter()<br>
      getter() method iife ke andar ke mess variable ke value ko print kar raha hai.<br>
      setter() method se user iife ke mess variable ke value ko change( reassign) karsakta hai.<br>
      IIFE jo object return kar raha hai wo get variable me store horaha hai.
      `,
      code8: `
...
`,
      content8: `
Is example mein, Is example me, IIFE function ek object return kar raha hai jiske andar teen methods hai increment() and decrement() and getCount()<br>
      increament() method iife ke andar ke count variable ko 1 se increment kar raha hai.<br>
      decreament() method iife ke andar ke count variable ko 1 se decrement kar raha hai.<br>
      getCount() method iife ke andar ke count variable ke value ko print kar raha hai.<br>
      IIFE jo object return kar raha hai wo counter variable me store horaha hai.<br>
      IIFEs ke wajah se, count variable aur uske methods sirf
